...
import "./chunk-VCTXKDXB.js";
import "./chunk-KMCEROUL.js";
import {
  InjectionToken,
  Injector,
  NgModule,
...
var firestoreInstance$ = timer(0, 300).pipe(concatMap(() => from2(ɵgetAllInstancesOf(FIRESTORE_PROVIDER_NAME))), distinct());
